...
Revision ID: 341972ef4cf4
Revises: d4ef3547a228
Create Date: 2021-08-15 19:33:23.472329
...
def upgrade():
    ...
    sa.Column('final_fecha', sa.String(length=100), nullable=False),
    ...
    sa.Column('geo_latitud', sa.String(length=120), nullable=False),
    sa.Column('geo_longitud', sa.Integer(), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
